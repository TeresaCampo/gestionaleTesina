...
public class Rental extends TravelOptionComponent {
    ...
    public void addRentalGraphicComponent(int layoutX, int layoutY, AnchorPane background) {
        ...
        tf_kindRental.setLayoutX(tf_name.getLayoutX() + tf_name.getPrefWidth() + 10);
        tf_kindRental.setLayoutY(tf_name.getLayoutY());
        ...
        lb_from.setLayoutY(tf_kindRental.getLayoutY() + 35);
