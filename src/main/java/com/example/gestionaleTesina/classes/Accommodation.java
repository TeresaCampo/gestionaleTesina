...
public class Accommodation extends TravelOptionComponent {
    ...
    void addAccommodationGraphicComponent(int layoutX, int layoutY, AnchorPane background) {
        ...
        lb_from.setLayoutY(tf_name.getLayoutY() + 35);
        ...
        lb_nOfRoom.setLayoutX(tf_name.getLayoutX());
        lb_nOfRoom.setLayoutY(lb_checkIn.getLayoutY() + 35);
        background.getChildren().add(lb_nOfRoom);

        tf_nOfRoom = new TextField();
        tf_nOfRoom.setPrefWidth(82);
        tf_nOfRoom.setLayoutX(lb_nOfRoom.getLayoutX() + lb_nOfRoom.getPrefWidth() + 10);
        tf_nOfRoom.setLayoutY(lb_nOfRoom.getLayoutY());
        background.getChildren().add(tf_nOfRoom);

        bt_sharedWC = new RadioButton("Private Toilet");
        bt_sharedWC.setPrefWidth(100);
        bt_sharedWC.setLayoutX(tf_nOfRoom.getLayoutX() + tf_nOfRoom.getPrefWidth() + 10);
        bt_sharedWC.setLayoutY(lb_nOfRoom.getLayoutY() + 5);
        ...
        lb_price.setLayoutY(lb_nOfRoom.getLayoutY() + 35);
        ...
        tf_price.setLayoutY(lb_nOfRoom.getLayoutY() + 35);
